...
Les secrets à forte confiance sont redigés avant embeddings et fragments de contexte. Le profil `content-v4` force la reconstruction d'un ancien index sémantique incompatible après l'extension de la redaction aux scalaires sensibles.
