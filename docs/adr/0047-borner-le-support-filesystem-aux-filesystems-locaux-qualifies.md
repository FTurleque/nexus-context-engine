...
NEXUS supporte officiellement les usages sur filesystem local lorsque les qualifications Linux/Windows de la version concernée sont vertes. Les filesystems réseau, distribués ou à sémantique spéciale ne sont **pas supportés par contrat** tant qu'une qualification explicite n'a pas été réalisée pour la technologie et la configuration concernées.
...
- une future extension réseau nécessitera une infrastructure de test adaptée.
...
- une infrastructure CI/reproductible permet de qualifier ces montages ;
